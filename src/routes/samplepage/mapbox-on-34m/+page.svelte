<!-- @see https://docs.mapbox.com/jp/mapbox-gl-js/example/add-3d-model/ -->

<script lang="ts">
  import * as THREE from 'three';
  import { GLTFLoader } from 'three/examples/jsm/loaders/GLTFLoader';
  import type { key, mapbox } from '../../common/map/mapbox';
  ...
  const modelOrigin:mapbox.LngLatLike = [148.9819, -35.39847];
  ...
  // @ts-ignore
  const customLayer: mapbox.AnyLayer = {
    id: '3d-model',
    type: 'custom',
    renderingMode: '3d',
...
<div class="h-screen w-screen">
  <Map lon={148.9819} lat={-35.3981} pitch={60} zoom={18} />
</div>
