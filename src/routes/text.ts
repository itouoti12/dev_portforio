...
export const defportforioTexts:PortforioTextProps = {
    ...
    'projects_1_product':{
        jp:'自動運転車両運行監視プラットフォーム「Dispatcher」',
    ...
    'projects_3_product':{
        jp:'代理店見込み顧客システム',
        en:'Agency Prospective Client System'
    },
    'projects_4_company':{
        jp:'ワイモバイル',
        en:'Y!mobile'
    ...
    'projects_6_product':{
        jp:'オープンソース「TERASOLUNA」',
        en:'Open source "TERASOLUNA"'
    },
    'projects_7_company':{
        jp:'ゆうちょ銀行',
        en:'Japan Post Bank'
