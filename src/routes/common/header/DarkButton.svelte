...
<button on:click={toggle}>
  <span
    class="mt-2 group inline-flex flex-shrink-0 justify-center items-center h-9 w-20 font-medium rounded-full
    bg-slate-700/50 hover:bg-slate-800/50 backdrop-blur-sm
    ">
    {#if $isDarkmode}
      <svg
